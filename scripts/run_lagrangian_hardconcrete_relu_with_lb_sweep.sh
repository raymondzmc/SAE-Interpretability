...
--sweep_config configs/tinystories/sweep/lagrangian_hardconcrete/relu_sweep_with_lb.yaml \
--output_dir experiment_outputs/relu_lagrangian_hardconcrete_sweep_with_lb

CUDA_VISIBLE_DEVICES=3 python evaluation.py \
--wandb_project raymondl/tinystories-1m-lagrangian-hardconcrete \
--filter_runs_by_name relu_lagrangian_hardconcrete_with_lb